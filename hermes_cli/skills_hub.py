...
def skills_command(args) -> None:
    ...
    if action == "browse":
        ...
        _console.print("Usage: hermes skills [browse|search|install|inspect|list|list-modified|diff|check|update|audit|uninstall|reset|opt-out|opt-in|publish|snapshot|tap|wiki]\n")
